...
class qq_login{
	...
	public function getqrpic(){
		...
		$url='https://xui.ptlogin2.qq.com/ssl/ptqrshow?s=8&e=0&appid=716027609&type=1&t=0.492909'.time().'&daid=383&pt_3rd_aid=100312028';
		$refer='https://xui.ptlogin2.qq.com/cgi-bin/xlogin?appid=716027609&daid=383&style=33&theme=2&login_text=%E6%8E%88%E6%9D%83%E5%B9%B6%E7%99%BB%E5%BD%95&hide_title_bar=1&hide_border=1&target=self&s_url=https%3A%2F%2Fgraph.qq.com%2Foauth2.0%2Flogin_jump&pt_3rd_aid=100312028&pt_feedback_link=https%3A%2F%2Fsupport.qq.com%2Fproducts%2F77942%3FcustomInfo%3Dwww.baidu.com.appid100312028';
			...
			if($r[0]==0){
				...
				if($data) {
					...
					if($mkey = $mkey[1]){
						...
						return array('code'=>-1,'uin'=>$uin,'msg'=>'登录QQ成功，获取mkey失败！');
					}
				}else{
	...
	public function qqconnect($redirect_uri, $mkey){
		if(empty($redirect_uri) || parse_url($redirect_uri, PHP_URL_HOST)!='passport.baidu.com')return array('code'=>-1,'msg'=>'回调地址错误');
	...
	private function getUserid($uname){
		$data = $this->get_curl('https://tieba.baidu.com/home/get/panel?ie=utf-8&un='.urlencode($uname));
